            ...
            <Card className="border-2 hover:border-primary transition-colors duration-300">
              <CardContent className="p-8">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-2xl font-semibold mb-3">Начало пути</h3>
                    <p className="text-muted-foreground leading-relaxed">
                      Мое творчество началось с простого желания создавать что-то красивое своими руками. 
                      Первые эксперименты со смолой, мазки кистью на холсте - каждый шаг открывал новый мир возможностей.
                    </p>
                  </div>
                </div>
              </CardContent>
            ...
            <Card className="border-2 hover:border-secondary transition-colors duration-300">
              <CardContent className="p-8">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-2xl font-semibold mb-3">Развитие навыков</h3>
                    <p className="text-muted-foreground leading-relaxed">
                      С каждым новым проектом я открываю для себя новые техники и материалы. 
                      Живопись, работа со смолой, создание поделок - все это помогает мне расти как творческому человеку.
                    </p>
                  </div>
                </div>
              </CardContent>
